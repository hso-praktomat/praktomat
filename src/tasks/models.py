...
class Task(models.Model):
    ...
    custom_id = models.CharField(max_length=255, blank=True, help_text = _("The custom ID of the task that is available as an environment variable within a checker (TASK_ID_CUSTOM). This is also used to replace the task ID in the external directory path for the checkers."))
